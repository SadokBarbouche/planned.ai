...
def split(df: pd.DataFrame) -> None:
    ...
    - It iterates through each unique city and creates a subset of data for that city.
    - Each subset of data is saved to an Excel file named '{city}_dataset.xlsx' in the 'cities' directory.
    """
